...
<!-- Adicione aqui os cards dos seus repositórios reais, um <td> por projeto. Exemplo: <table> <tr> <td width="50%"> <h4>🚀 Nome do Projeto</h4> Uma linha curta descrevendo o que o projeto faz. <br /><br /> <img src="https://img.shields.io/badge/.NET-512BD4?style=flat-square&logo=dotnet&logoColor=white" /> <br /><br /> <a href="https://github.com/Mr-Tetin/nome-do-repo">🔗 Ver repositório</a> </td> </tr> </table> -->
